...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _cardsContainer = __webpack_require__(183);
	...
	var App = function (_Component) {
	  ...
	  function App(props) {
	    ...
	    _this.searchPages = _this.searchPages.bind(_this);
	    _this.showFavPages = _this.showFavPages.bind(_this);
	    _this.addToFav = _this.addToFav.bind(_this);
	    return _this;
	  }
	  ...
	  _createClass(App, [{
	    ...
	    key: 'showFavPages',
	    value: function showFavPages(event) {
	      var val = this.state.pointer ? 'Click to see All pages' : 'Click to See Favourite Pages';
	    ...
	    key: 'searchPages',
	    value: function searchPages(event) {
	      var _this3 = this;
	      ...
	      if (event.key == 'Enter') {
	        (0, _Util.request)({ url: 'https://graph.facebook.com/v2.9/search?q=' + event.target.value + '&type=page&access_token=' + access_token }).then(function (data) {
	          data.data.forEach(function (obj, key) {
	            var _this2 = this;

	            if (key < 4) {
	              (0, _Util.request)({ url: 'https://graph.facebook.com/v2.9/' + obj.id + '?fields=id%2Cabout%2Ccategory%2Cpicture%2Ccompany_overview&access_token=' + access_token }).then(function (page) {
	                pages.push(page);
	    ...
	    key: 'addToFav',
	    value: function addToFav(eve, page) {
	      var tempArr = this.state.favPages.slice(0);
	      var allPagesArr = this.state.pages.slice(0);
	      page.fav = !page.fav;
	      if (page.fav) {
	        tempArr.push(page);
	      } else {
	        tempArr = tempArr.filter(function (currpage) {
	          return page.id != currpage.id;
	        });
	        allPagesArr = allPagesArr.map(function (pg) {
	          if (pg.id == page.id) {
	            pg.fav = false;
	            return pg;
	          }
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_searchBar.SearchBar, { searchPages: this.searchPages, showFavPages: this.showFavPages }),
	        this.state.pointer ? _react2.default.createElement(_cardsContainer.CardsContainer, { pages: this.state.pages, addToFav: this.addToFav }) : _react2.default.createElement(_cardsContainer.CardsContainer, { pages: JSON.parse(localStorage.getItem('fav')), addToFav: this.addToFav })
	      );
	    }
	  }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var SearchBar = exports.SearchBar = function SearchBar(props) {
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement("input", { type: "text", placeholder: "Search Facebook Pages", onKeyPress: function onKeyPress(event) {
	        return props.searchPages(event);
	      } }),
	    _react2.default.createElement(
	      "a",
	      { onClick: function onClick(event) {
	          return props.showFavPages(event);
	        } },
	      "Click to See Favourite Pages"
	    )
	  );
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.CardsContainer = undefined;
	...
	var CardsContainer = exports.CardsContainer = function CardsContainer(props) {
	    ...
	    pages.map(function (page, key) {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement('img', { src: page.picture.data.url }),
	          _react2.default.createElement(
	            'div',
	            { className: 'details' },
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement('img', { src: page.fav ? './images/favRemove.png' : './images/fav.png', onClick: function onClick(event) {
	              return props.addToFav(event, page);
	            } })
	        )
	      );
	    })
